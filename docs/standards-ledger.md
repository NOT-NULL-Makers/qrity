...
|---|---|---|---|
| 1. Data analysis | Clauses 7.2–7.4; Tables 2, 3, 5, and 7; Annex J | Minimum-single-mode payload classification is implemented; Numeric and Alphanumeric orchestration validate their exact repertoires; Table 7 capacities support count-based Version 1–40 selection for explicit L/M/Q/H | Byte packing, optimal segmentation, and non-default ECI remain unimplemented |
| 2. Data encoding | Clauses 7.4.1, 7.4.3–7.4.4, 7.4.9, and 7.4.10; Tables 2, 3, 5, and 7; Annex I.2 | Fixed pipeline plus provisional selected-profile Numeric and Alphanumeric construction; Alphanumeric uses mode `0010`, 9/11/13-bit counts, 11/6-bit groups, terminator, alignment, and alternating pads | Independent references cover every Numeric and Alphanumeric maximum and maximum-plus-one across all 160 profiles; Alphanumeric also pins the printed `AC-42` vector |
...
| Numeric and Alphanumeric character-count bands, terminator, alignment, and padding | Tables 2–3; Clauses 7.4.3–7.4.4, 7.4.9–7.4.10 | Independent references across all 160 maximum capacities per mode; pinned V9→V10 and V26→V27 transitions; all 0–4 Terminator lengths | Provisional selected-profile Numeric and Alphanumeric data-codeword construction |
...
select a deterministic minimum. Provisional `encode-numeric` and
`encode-alphanumeric` compose them after smallest-version selection across all
...
Stable API design and broader high-density decoder evidence remain deferred.
Alphanumeric is now a complete single-segment encoding path; Byte remains capacity
planning only.
