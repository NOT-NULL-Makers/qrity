...
| Data and error-correction interleaving order | Clause 7.6; Version 5-H worked block shape | Independent column-first reference over all 160 layouts; exact unequal V5-H fixture; real test-only per-block Reed–Solomon composition; JVM, Node, and Babashka checks | Provisional pure partition/data-interleave/EC-interleave primitives; generalized final-message orchestration remains deferred |
