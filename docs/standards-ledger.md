...
The selected-profile primitives can now construct and score all eight complete
candidates and select a deterministic minimum. The stable complete generation pipeline
remains Version 1-M Numeric/mask 2 until generalized orchestration and broader decoder
